                        ...
                        <div class="clearfix">
                            ...
                            <table class="table table-striped table-bordered table-advance table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#"><?php echo mb_substr($item['title'],0,15); ?></a></td>
                                    <td><?php echo $item['id']; ?></td>
                                    <td><?php echo mb_substr($item['info'],0,15); ?></td>
                                    <td><?php echo $item['topic_label']; ?></td>
                                    <td><?php echo $item['commnet_ids']; ?></td>
                                    <td><img width="50" height="50" src="<?php echo $serverDddr; ?><?php echo $item['img']; ?>"></td>
                                    <td>
                                        <button class="btn btn-primary"><i class="icon-pencil"></i></button>
                                        <button class="btn btn-danger" onclick="deleteItem('<?php echo $item['id']; ?>')"><i
